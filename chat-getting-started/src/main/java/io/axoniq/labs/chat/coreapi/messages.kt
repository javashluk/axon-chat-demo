...
data class StartSchedulingTestCommand(@TargetAggregateIdentifier val id: String?)
data class StartSchedulingTestEvent(val id: String?)
data class EndTestEvent(val id: String?)
data class ScheduledFromSagaEvent(val id: String?)